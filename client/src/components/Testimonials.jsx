...
const testimonials = [
  {
    quote: 'MedXL transformed our hospital operations completely. Their HMS reduced our patient wait times by 40% and the analytics dashboard gives us real-time visibility we never had before. The team is exceptional — true partners, not just vendors.',
  ...
  {
    quote: 'Partnering with MedXL gave us a 28% jump in patient satisfaction and generated an additional 7.5M CAD in revenue within the first year. Their team understood our clinical workflows from day one and built software that our staff actually loves using.',
  ...
  {
    quote: 'MedXL\'s data analytics solution cut our paperwork by 50% and improved data accuracy by 35%. For the first time, our administrators and clinicians work from the same source of truth. The ROI was visible within three months of going live.',
