...
const services = [
  ...
  { icon:'📊', color:'#0f1de7', bg:'rgba(168,85,247,.1)',  border:'rgba(168,85,247,.22)',  title:'Data Analytics & Reporting',       desc:'Monthly performance dashboards covering website traffic, patient acquisition, social reach, and operational KPIs — insights that drive decisions.', tags:['Dashboards','Real-time BI','KPI Tracking','Predictive Reports'] },

{ icon:'🎓', color:'#810202', bg:'rgba(248,113,113,.1)', border:'rgba(248,113,113,.22)', title:'Staff IT Training & Onboarding',   desc:'Structured onboarding sessions for all software tools, ongoing training modules, and documentation to ensure your team is always up to speed.', tags:['Onboarding','LMS Modules','Documentation','Hands-on Sessions'] },

{ icon:'💬', color:'#e2ed0e', bg:'rgba(74,222,128,.1)',  border:'rgba(74,222,128,.22)',  title:'Complimentary IT Consultation',    desc:'Quarterly (or monthly on higher plans) strategy sessions with our healthcare IT experts — roadmap reviews, technology assessments, and growth advisory.', tags:['Roadmap Review','Tech Assessment','Growth Advisory','Strategy Sessions'] },
]
