    ...
    <div style={{
      ...
      {[
        ...
        },
        {
          ...
          quote: "MedXL's telemedicine module integrated with our existing HMS in under a week. We now run virtual ward rounds for post-op patients and have reduced unnecessary readmissions significantly. The video quality is excellent.",
          name: 'Dr. Khalid Al-Mansouri',
          role: 'Chief Medical Officer',
          hospital: 'Gulf Care Hospital, Muscat, Oman',
          avatar: '👨‍⚕️',
          foreign: true,
        },
        {
        ...
        },
        {
          ...
          quote: 'We have a multi-nationality staff across three facilities. MedXL LMS gave us one unified training platform with multilingual support. CPD tracking and audit-ready compliance reports made our last accreditation review seamless.',
          name: 'Ms. Fatima Al-Rashid',
          role: 'HR & Training Director',
          hospital: 'Riyadh Medical Complex, Riyadh, KSA',
          avatar: '👩‍💼',
          foreign: true,
        },
      ].map(r => (
        <div className="mx-card" key={r.name} style={{ display:'flex', flexDirection:'column', gap:14 }}>
          ...
          {/* Product label + optional International chip */}
